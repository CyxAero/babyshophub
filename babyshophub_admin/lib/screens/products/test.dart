...
class ProductDetailsPageNew extends StatefulWidget {
  ...
  const ProductDetailsPageNew({super.key, required this.product});

  @override
  State<ProductDetailsPageNew> createState() => _ProductDetailsPageState();
}

class _ProductDetailsPageState extends State<ProductDetailsPageNew> {
